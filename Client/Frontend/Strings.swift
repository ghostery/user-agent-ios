...
extension Strings {
    ...
    public static let AppMenuDownloadsTitleString = NSLocalizedString("Menu.Downloads.Title", tableName: "Menu", comment: "Label for the button, displayed in the menu, used to open Downloads.")
