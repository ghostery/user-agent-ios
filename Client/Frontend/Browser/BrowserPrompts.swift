...
struct MessageAlert: JSAlertInfo {
    ...
    func alertController() -> JSPromptAlertController {
        ...
        alertController.addAction(UIAlertAction(title: Strings.General.OKString, style: .default) { _ in
...
struct ConfirmPanelAlert: JSAlertInfo {
    ...
    func alertController() -> JSPromptAlertController {
        ...
        alertController.addAction(UIAlertAction(title: Strings.General.CancelString, style: .cancel) { _ in
            self.cancel()
        })
        alertController.alertInfo = self
        return alertController
