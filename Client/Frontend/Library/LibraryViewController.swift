...
class LibraryViewController: UIViewController {
    ...
    fileprivate lazy var buttonContainerView: UIStackView = {
        ...
        stackView.accessibilityLabel = NSLocalizedString("Panel Chooser", comment: "Accessibility label for the Library panel's bottom toolbar containing a list of the home panels (top sites, bookmarks, history, remote tabs).")
        return stackView
    }()
