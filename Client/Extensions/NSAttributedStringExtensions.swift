...
extension NSAttributedString {
    static func tableRowTitle(_ string: String, enabled: Bool) -> NSAttributedString {
        let color = enabled ? [NSAttributedString.Key.foregroundColor: Theme.tableView.rowText] : [NSAttributedString.Key.foregroundColor: Theme.tableView.disabledRowText]
