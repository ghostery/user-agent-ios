...
struct TopTabsUX {
    static let TopTabsViewHeight: CGFloat = 36
    ...
    static let TabTitlePadding: CGFloat = 5
    static let TabCloseButtonImagePadding: CGFloat = 12
...
class TopTabsViewController: UIViewController {
    ...
    lazy var privateModeButton: PrivateModeButton = {
        ...
        privateModeButton.imageEdgeInsets = UIEdgeInsets(top: 7, left: 7, bottom: 7, right: 7)
